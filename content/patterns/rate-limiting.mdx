...
learningObjectives:
  - Explain why APIs cap how fast a client can send requests
  - Identify where rate limits belong at the edge versus the app
  - Relate rate limiting to load balancing and queues
---
