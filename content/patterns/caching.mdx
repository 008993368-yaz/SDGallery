...
learningObjectives:
  - Explain what a cache hit and miss mean for origin load
  - Decide when caching is appropriate for read-heavy data
  - Relate application caching to CDNs at the edge
---
