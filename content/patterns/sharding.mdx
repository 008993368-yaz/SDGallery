...
learningObjectives:
  - Explain how a partition key splits data across machines
  - Identify hot-key and cross-shard query risks
  - Relate sharding to caches and queues in a scaled data path
---
