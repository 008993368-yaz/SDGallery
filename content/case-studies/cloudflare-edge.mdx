...
```mermaid caption="High-level architecture" explanation="Anycast lands users at a nearby POP; rate limits and cache checks run before expensive origin work, and misses fill through health-aware origin load balancing."
flowchart LR
