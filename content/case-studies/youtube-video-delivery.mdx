...
```mermaid caption="High-level architecture" explanation="Creators upload into ingest and processing; viewers hit a nearby CDN edge for segments while watch/metadata APIs sit behind load balancers over sharded stores."
flowchart LR
